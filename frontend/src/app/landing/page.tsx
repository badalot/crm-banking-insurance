        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-600">Banking & Insurance</span>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            La solution CRM pour le{' '}
            <span className="block text-blue-600">secteur bancaire et assurance</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Gérez vos clients, optimisez vos processus KYC/AML, et analysez vos performances
            avec une plateforme tout-en-un conçue pour l'Afrique.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600">
                Interface responsive, mode hors ligne, intégration Mobile Money (Orange Money, Wave, MTN) pour l'Afrique.
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Rejoignez les entreprises qui font confiance à notre plateforme
          </p>
          <Link
            href="/register"
            className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
      ...
      <footer className="border-t border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center text-gray-600">
            <p className="mb-2">© 2026 CRM Banking & Insurance. Tous droits réservés.</p>
            <p className="text-sm">Plateforme conçue pour le secteur bancaire et assurance en Afrique</p>
          </div>
        </div>
      </footer>
    </div>
